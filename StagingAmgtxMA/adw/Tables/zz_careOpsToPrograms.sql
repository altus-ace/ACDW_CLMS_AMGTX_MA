CREATE TABLE [adw].[zz_careOpsToPrograms] (
    [CareOpsProgramKey]        INT           IDENTITY (1, 1) NOT NULL,
    ...
    [ActiveMembersCsPlanName]  VARCHAR (20)  NULL,
    ...
    PRIMARY KEY CLUSTERED ([CareOpsProgramKey] ASC)
);
