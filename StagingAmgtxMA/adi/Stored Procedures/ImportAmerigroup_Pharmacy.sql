...
BEGIN
 ...
 VALUES  (
	...
	@HypertensionDrugLastDaysSupply  ,
	CASE WHEN @NextRefillDateHypertension    =''
	THEN NULL
	ELSE CONVERT(DATE,	@NextRefillDateHypertension )
	END,
	...
	@Cholesteroldruglastdayssupply  ,
	CASE WHEN @NextrefillDateCholesterol   =''
	THEN NULL
	ELSE CONVERT(DATE,@NextrefillDateCholesterol )
	END,
