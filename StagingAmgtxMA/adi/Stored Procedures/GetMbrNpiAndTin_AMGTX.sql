...
CREATE PROCEDURE [adi].[GetMbrNpiAndTin_AMGTX] (@LoadDate DATE, @RowStatus INT,@ClientKey INT) -- [adi].[GetMbrNpiAndTin_AMGTX]'2021-12-01',0,21

AS
					-- DECLARE @LoadDate DATE = '2021-04-15' DECLARE @RowStatus INT = 0 DECLARE @ClientKey INT = 21
