CREATE TABLE [adi].[Amerigroup_DXCG] (
    [Amerigroup_DXCGKey]                                      INT            IDENTITY (1, 1) NOT NULL,
    [OriginalFileName]                                        VARCHAR (100)  NOT NULL,
    [SrcFileName]                                             VARCHAR (100)  NOT NULL,
    [LoadDate]                                                DATE           NOT NULL,
    [CreatedDate]                                             DATETIME       CONSTRAINT [DF_Amerigroup_DXCG1] DEFAULT (getdate()) NULL,
    [DataDate]                                                DATE           NOT NULL,
    [FileDate]                                                DATE           NOT NULL,
    [CreatedBy]                                               VARCHAR (50)   CONSTRAINT [DF_Amerigroup_DXCG2] DEFAULT (suser_sname()) NOT NULL,
    [LastUpdatedDate]                                         DATETIME       CONSTRAINT [DF_Amerigroup_DXCG3] DEFAULT (getdate()) NOT NULL,
    [LastUpdatedBy]                                           VARCHAR (50)   CONSTRAINT [DF_Amerigroup_DXCG4] DEFAULT (suser_sname()) NOT NULL,
    ...
    PRIMARY KEY CLUSTERED ([Amerigroup_DXCGKey] ASC)
);
